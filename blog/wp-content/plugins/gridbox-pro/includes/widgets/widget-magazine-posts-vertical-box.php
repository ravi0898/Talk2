 ...
 */
class Gridbox_Pro_Magazine_Vertical_Box_Widget extends WP_Widget {
	...
	function __construct() {
		...
		// Setup Widget.
		parent::__construct(
			'gridbox-magazine-vertical-box', // ID.
	...
	private function default_settings() {
		...
		$defaults = array(
			'title'    => esc_html__( 'Magazine (Vertical Box)', 'gridbox-pro' ),
			'category' => 0,
		);
	...
	function render( $settings ) {
		...
		// Get cached post ids.
		$post_ids = gridbox_get_magazine_post_ids( $this->id, $settings['category'], 5 );
