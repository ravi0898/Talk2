...
if ( class_exists( 'WP_Customize_Control' ) ) :
	...
	class Gridbox_Pro_Customize_Font_Control extends WP_Customize_Control {
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			$this->l10n = array(
				'previous' => esc_html__( 'Previous Font', 'gridbox-pro' ),
				'next'     => esc_html__( 'Next Font', 'gridbox-pro' ),
				'standard' => esc_html_x( 'Default', 'default font button', 'gridbox-pro' ),
			);

			// Set Fonts.
			$this->fonts = Gridbox_Pro_Custom_Fonts::get_available_fonts();
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'gridbox-pro-custom-font-control', GRIDBOX_PRO_PLUGIN_URL . 'assets/js/custom-font-control.min.js', array( 'customize-controls' ), '20210212', true );
		}
