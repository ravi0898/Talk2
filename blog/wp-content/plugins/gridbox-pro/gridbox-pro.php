...
class Gridbox_Pro {
	...
	static function constants() {
		...
		define( 'GRIDBOX_PRO_VERSION', '2.2' );
	...
	static function includes() {
		...
		require_once GRIDBOX_PRO_PLUGIN_DIR . 'includes/modules/class-author-bio.php';
		require_once GRIDBOX_PRO_PLUGIN_DIR . 'includes/modules/class-block-colors.php';
		...
		require_once GRIDBOX_PRO_PLUGIN_DIR . '/includes/modules/class-header-search.php';
		require_once GRIDBOX_PRO_PLUGIN_DIR . '/includes/modules/class-header-spacing.php';
		require_once GRIDBOX_PRO_PLUGIN_DIR . '/includes/modules/class-scroll-to-top.php';
		require_once GRIDBOX_PRO_PLUGIN_DIR . 'includes/modules/class-widget-areas.php';
	...
	static function setup_actions() {
		...
		// Enqueue Gridbox Pro Stylesheet.
	...
	static function enqueue_styles() {
		...
		// Enqueue Custom CSS.
		wp_add_inline_style( 'gridbox-pro', self::get_custom_css() );
	}
	...
	static function enqueue_editor_styles() {
		...
		// Enqueue Custom CSS.
		wp_add_inline_style( 'gridbox-editor-styles', self::get_custom_css() );
	}
