                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-content d-flex flex-wrap justify-content-between align-items-center">
                        <div class="section-heading">
                            <h2 class="sec__title line-height-45">Bought Services </h2>
                        </div><!-- end section-heading -->
                        <ul class="list-items d-flex align-items-center">
                            <li class="active__list-item"><a href="dashboard.php">Home</a></li>
                            <li class="active__list-item">Bought Services</li>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="manage-candidate-wrap">
                                                    <h2 class="widget-title pb-1 font-size-15"><a href="#" class="color-text-2">1</a></h2>
                                                </div><!-- end manage-candidate-wrap -->
                                            </td>
                                            <td class="font-weight-medium">Srk</td>
                                             <td class="">
                                                <div class="manage-candidate-wrap">
                                                    <div class="bread-action pt-0">
                            <ul class="">
                              <li class="d-inline-block text-success"> Active</li>
                              <!-- <li class="d-inline-block"><i class="la la-circle text-success"></i>in Active</li> -->
                                            ...
                                            <td class="font-weight-medium text-center">
                                                <a href="<?php echo base_url();?>user/" class="btn btn-info">Talk2 an Expert</a></td>
