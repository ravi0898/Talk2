                ...
                <div class="billing-form-item mb-0">
                    ...
                    <div class="billing-content">
                        <div class="contact-form-action">
                            ...
                            <form method="POST" action="<?php echo base_url();?>vendor/forgot_pass">
                                <div class="input-box">
                                ...
                                <p>
                                    <a href="<?php echo base_url();?>vendor" class="color-text">Login</a>
                                    or
                                    <a href="<?php echo base_url();?>vendor" class="color-text">Register</a>
                                </p>
                            </form>
