...
<h2 class="sec__title mb-0">Vendor</h2>
...
<img src="<?php echo base_url();?>assets/images/services-img.jpg" class="img-fluid">
...
<li class="nav-item">
<a class="nav-link theme-btn <?php if($reg_id=='' || $reg_id=='loginAction' ){ echo 'active'; }?>" id="login-tab" data-toggle="tab" href="#login-nav" role="tab" aria-controls="login-nav" aria-selected="true">
<i class="la la-sign-in"></i> Login to Account
</a>
</li>
<li class="nav-item">
<a class="nav-link theme-btn <?php if($reg_id=='vend_signup'){ echo 'active'; }?>" id="signup-tab" data-toggle="tab" href="#signup-nav" role="tab" aria-controls="signup-nav" aria-selected="false">
...
<div class="tab-pane fade <?php if($reg_id=='' || $reg_id=='loginAction'){ echo 'active show'; }?>" id="login-nav" role="tabpanel" aria-labelledby="login-tab">
...
<form method="POST" action="<?php echo base_url('vendor/loginAction');?>">
<div class="row">
<div class="col-lg-12">
<div class="input-box">
...
<div>
<a href="<?php echo base_url();?>vendor/forget" class="color-text">Forgot password?</a>
</div>
</div>
</div>
</div><!-- end col-lg-12 -->
...
<div class="col-lg-6 responsive-column mx-auto text-center">
<a class="theme-btn bg-7 border-0 w-100" href="<?php echo base_url();?>vendor/login_with_gmail">
...
<div class="tab-pane fade <?php if($reg_id=='vend_signup'){ echo 'active show'; }?>" id="signup-nav" role="tabpanel" aria-labelledby="signup-tab">
<div class="billing-form-item mb-0">
<div class="billing-title-wrap border-bottom-0 text-center">
...
<strong class="color-text-2 font-weight-medium">Already have an account? <a href="javascript:void(0)" class="color-text">Sign In</a></strong>
</p>
</div><!-- billing-title-wrap -->
<div class="billing-content">
<div class="contact-form-action">
<form method="POST" action="<?php echo base_url('vendor/vend_signup');?>">
<div class="input-box">
...
<label for="chb3">I Agree to Talk2 <a href="<?php echo base_url();?>home/privacy" class="color-text">Privacy Policy</a> and <a href="<?php echo base_url();?>home/terms" class="color-text">Terms and Conditions</a></label>
<small class="text-danger"><?php echo form_error('terms'); ?></small>
