                    ...
                    <div class="dashboard-message-wrapper d-flex">
                        <div class="message-sidebar">
                            ...
                            <div class="message-inbox-item">
                                ...
                                $user_ids  = $chtroomlist['user_id'];
                                $list_date = $chtroomlist['date'];
                                $list_chat_id = $chtroomlist['chat_id'];
                                $getlist  = $this->Model->getData('user', array('user_id'=>$user_ids));
                                // old date from database
                                $t_time   = strtotime($list_date);
                                // current date
                                $f_time = strtotime($currnt_time);

                                $time_min = round(($f_time - $t_time) / 60). "minute ago";
                                @$ti_sec = $time_min * 60 ;

                                $t_elapsed = timeAgo($ti_sec);

                                ?>
                                    <a href="<?php echo base_url();?>vendor/chat/<?php echo $list_chat_id;?>" class=" d-block message-inbox message-active">
                                        <div class="mess__item">
                                            <div class="avatar online-status">
                                                <img src="<?php echo base_url();?>uploads/user_images/<?php echo $getlist->profile;?>" alt="Michelle Moreno">
                                            </div>
                                            <div class="content">
                                                ...
                                                <span class="time color-text-3 font-size-12"><?php echo $t_elapsed;?></span>
                                            </div>
                                        </div>
                                    </a>
                                    <?php } ?>                                   
                        ...
                        if(!empty($creator)){
                         ...
                         $chat_uid     = $chatview->user_id;
                         $chat_id      = $chatview->chat_id;

                         $getudata = $this->Model->getData('user', array('user_id'=>$chat_uid));
                        ...
                        <div class="message-content flex-grow-1">
                            <div class="message-header">
                                <div class="mess__item justify-content-between align-items-center">
                                    <div class="d-flex">
                                        <div class="avatar">
                                            <img src="<?php echo base_url();?>uploads/user_images/<?php  echo $getudata->profile; ?>" alt="Michelle Moreno">
                                        </div>
                                        <div class="content">
                                            <h4 class="widget-title font-size-15 mb-0"><?php  echo $getudata->fname; ?></h4>
                                            <span class="time color-text font-size-14"><?php  echo $getudata->last_activity; ?></span>
                                        </div>
                                    </div>
                                    <!-- <div>
                                        <ul class="info-list">
                            ...
                            <div class="message-reply-input d-flex align-items-center">
                                ...
                                <div class="message-send  ml-2">
                                    ...
                                    <button type="submit" id="chat_btn" class="chat_btn"><i class="la la-paper-plane"></i>
                                    </button>
                                </div>
                            </div><!-- message-reply-input -->

                        </form>
                            <div class="px-2 py-1"> <a class="btn btn-info mb-2" href="<?php echo base_url();?>vendor/create_meeting/<?php echo $chat_id;?>" target="_blanck">Create meeting</a><br></div>
                        </div>
                        <!-- message end -->
                        <?php }else{ ?>
                            <center>
                       <div class="img-fluid pt-4 pb-4">
                          <img class="mx-0" src="<?php echo base_url();?>assets/images/nodata-found.png" width="50%">
                       </div>
                       </center>
                        <?php } ?>
...
$("#form_chat").on('submit',(function(e) {
  ...
  $.ajax({
   url: "<?php echo base_url();?>vendor/do_chat",
   type: "POST",
 ...
 <script> 
  $(document).ready(function(){
    ...
    setInterval(function(){
      $('.load_chat').load('<?php echo base_url()?>vendor/show_load_chat/<?php echo $chat_id;?>')
