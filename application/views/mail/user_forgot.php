...
<tbody>
    ...
    <tr>
        ...
        To reset your password , click on the button below:<br>
            ...
            <a href="<?php echo base_url();?>user/reset/<?php echo $getuser->user_id;?>" style='background: #69d065; padding: 10px 20px; margin: 10px; border-radius: 4px;color: #000; font-weight: 700; text-decoration: none;'>Reset Password</a>
            </center>
