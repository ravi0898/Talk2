...
<tr>
<td>
<table bgcolor='#ffffff' class='content' align='center' cellpadding='0' cellspacing='0' border='0' style='background: #fff;'>
<tr>
<td bgcolor='#fff' class='header' style='text-align: center;
    display: table;
    margin: 0 auto;'>
<center>
...
<img class='fix' src='<?php echo base_url();?>assets/images/talk2-logo.png' width='200' height='' border='0' alt=''/>
</td>
</tr>
</table>
</center>
...
<tbody>
    ...
    <tr>
        <td valign='top' height='25' width='100' style='font-size: 18px; color: rgb(51, 51, 51); font-weight: normal; text-align: left; font-family: &quot;Open Sans&quot;, Arial, Helvetica, sans-serif; word-break: break-word; line-height: 120%; cursor: text;' panel-color='color_table' editor='content' class='relative_index2'>
            <span style='text-decoration: none;line-height: 24px;font-size: 20px;color: rgb(51, 51, 51);font-weight: bold;'>Hi <?php echo $getuser->fname;?>!</span>
        </td>
    </tr>
</tbody>
</table>
...
<tbody>
    ...
    <!-- end space -->
    <tr>
        <td valign='top' height='25' width='100' style='font-size: 14px; color: rgb(136, 136, 136); font-weight: normal; text-align: left; font-family: &quot;Open Sans&quot;, Arial, Helvetica, sans-serif; word-break: break-word; line-height: 30px; cursor: text;' panel-color='color_table' editor='content' class='relative_index2'>Thank you for signing up for our Talk2 an expert Portal To get you started, please click on the button below to verify your account for the first time.<br>
            <center style='padding-top:10px;padding-bottom:10px;'>
            <a href="<?php echo base_url();?>user/verify_account/<?php echo $getuser->user_id;?>" style='background: #69d065; padding: 10px 20px; margin: 10px; border-radius: 4px;color: #000; font-weight: 700; text-decoration: none;'>verify</a>
            </center>
     ...
     <tr>
        ...
        If you experience any issues logging into your account, reach out to us at support@talk2.com                   
        </td>
    </tr>
...
<tbody>
    ...
    <!-- end space -->
    <tr>
        <td valign='top' height='25' width='100' style='font-size: 14px; color: rgb(136, 136, 136); font-weight: normal; text-align: left; font-family: &quot;Open Sans&quot;, Arial, Helvetica, sans-serif; word-break: break-word; line-height: 140%; cursor: text;' panel-color='color_table' editor='content' class='relative_index2'>Regards,<br>Talk2 an expert Support Team
        </td>
    </tr>
    <!-- start space -->
    <tr>
