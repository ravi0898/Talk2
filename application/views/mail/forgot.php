...
<tbody>
    ...
    <tr>
        ...
        To reset your password , click on the button below:<br>
            ...
            <a href="<?php echo base_url();?>vendor/reset/<?php echo $getuser->vendor_id;?>" style='background: #69d065; padding: 10px 20px; margin: 10px; border-radius: 4px;color: #000; font-weight: 700; text-decoration: none;'>Reset Password</a>
            </center>
     ...
     <tr>
        ...
        If you did not initiate this request, please contact us immediately at support@talk2.com                  
        </td>
    </tr>
